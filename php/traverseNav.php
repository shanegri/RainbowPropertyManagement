<?php function showNav($listSize, $pp){ ?>
<div class="container-fluid" style="height: 40px; font-size: 12px;">
  <form method="post">
    <div class="row card">
      <div class="col-xs-6" >
      <p class="hidden-xs" style="float: left; margin-top: 7px;"><i>Showing <?php echo $pp; ?> per page , <?php echo $listSize; ?> total </i></p>
      ...
      <p style="float: right; margin-top: 7px;">Page <?php echo ($_SESSION['page'] + 1) . ' / ' . (floor($listSize/$pp)+1)?></p>
      </div>
      </div>
  </form>
</div>
